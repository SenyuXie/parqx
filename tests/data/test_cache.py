...
def test_evicts_oldest_when_budget_exceeded() -> None:
    cache = BudgetedLRU[str, str](budget_bytes=5, sizeof=len)
...
def test_oversized_entry_is_kept_when_alone() -> None:
    cache = BudgetedLRU[str, str](budget_bytes=3, sizeof=len)
